...
P6654 = Proj(init='epsg:6654')
P2955 = Proj(init='epsg:2955')
...
cfg = read_cfg("W:\\EDM\\RSGIS\\hqiu\\generate_dataset_gis2img\\default.yml")
...
output_file_6654 = "Cynthia20240816_2048centralFootprints_EPSG6654"
output_file_center_6654 = "Cynthia20240816_2048centralFootprints_EPSG6654_centroids"
output_file_2955 = "Cynthia20240816_2048centralFootprints_EPSG2955"
output_file_center_2955 = "Cynthia20240816_2048centralFootprints_EPSG2955_centroids"
w6654 = shapefile.Writer(output_file_6654, shapefile.POLYGON)
w6654_center = shapefile.Writer(output_file_center_6654, shapefile.POINT)
w2955 = shapefile.Writer(output_file_2955, shapefile.POLYGON)
w2955_center = shapefile.Writer(output_file_center_2955, shapefile.POINT)
w6654.field('field1', 'C', size=250)
w6654_center.field('field1', 'C', size=250)
w2955.field('field1', 'C', size=250)
w2955_center.field('field1', 'C', size=250)
...
for i in range(len(img_data)):
    ...
    x,y = transform(P4326, P2955, lon, lat)
    ...
    #tmpc = np.array([image_width//2+cx,image_height//2+cy])
    points = np.array([[image_width//2+cx,image_height//2+cy],[image_width//2+cx - cropped_width//2,image_height//2+cy - cropped_height//2],[image_width//2+cx + cropped_width//2,image_height//2+cy - cropped_height//2],[image_width//2+cx + cropped_width//2,image_height//2+cy + cropped_height//2],[image_width//2+cx - cropped_width//2,image_height//2+cy + cropped_height//2]])
    ...
    print(curr_poly)
    w2955.poly([curr_poly.tolist()[1:]])
    w2955.record(img_path, dist, 'Polygon') 

    w2955_center.point(curr_poly.tolist()[0][0], curr_poly.tolist()[0][1])
    print('center',curr_poly.tolist()[0][0], curr_poly.tolist()[0][1])
    w2955_center.record(img_path, dist, 'Point') 
